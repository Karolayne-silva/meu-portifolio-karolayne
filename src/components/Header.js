      ...
      <header className={hasScrolled ? "header scrolled" : "header"}>
        <div className="header-in">
          ...
          <div className="imgs-header">
            <img src={!dark ? imgLetra : imgLetraB} alt="letra k" className="img-letra" />
            <img src={!dark ? animacao : animacaoB} alt="circulo ondulado" className="animation"/>
          </div>
          ...
          <div  className="menu" onClick={()=>{
            ...
            <ul className={menuOpen ? "open": ""}>
              ...
              <li><Toggle handleChange={() => setDark(!dark)} isChecked={dark} /></li>
            </ul>
